...
class DCGenerator(nn.Module):
    def __init__(self, noise_size, conv_dim, spectral_norm):
...
class CycleGenerator(nn.Module):
    ...
    """
    def __init__(self, conv_dim=64, init_zero_weights=False, spectral_norm=False):
    ...
    def forward(self, x):
        ...
        out = torch.tanh(self.upconv2(out))
...
class DCDiscriminator(nn.Module):
    ...
    def __init__(self, conv_dim=64, spectral_norm=False):
        ...
        self.conv4 = conv(conv_dim * 2, 1, 5, stride=1, padding=1, batch_norm=False)
