...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder', default = "GRUEncoder",  choices=["GRUEncoder", "TransformerEncoder"], help="encoder to run")
    parser.add_argument('--decoder', default = "GRUDecoder", choices=["GRUDecoder", "GRUAttentionDecoder", "TransformerDecoder"], help="decoder to run")
